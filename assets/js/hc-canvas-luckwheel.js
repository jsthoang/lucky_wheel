var baseUrl = "https://lixicaerux.herokuapp.com/";
...
(async function async() {
    ...
    await fetch("https://lixicaerux.herokuapp.com/gift")
        ...
        hcLuckywheel.init({
            ...
            gotBack: async function (data) {
                if (data == null) {
                    ...
                    setTimeout(() => {
                        Promise.all([getGifts({ ...user, gift: data }), updateUse(user)]).then((document.querySelector("#timesSpin").innerHTML = user.timesSpin));
                    }, 2000);
                }
            },
        });
